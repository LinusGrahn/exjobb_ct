...
const opCut = {
  details: {
    ...
    description: "text about this operation, text about this operation, text about this operation, text about this operation, text about this operation",
...
const materialDetail = {
  details: {
    ...
    description: "trä och färdig produkt",
    // parameterStatus: "Kapa MÅTTEN av SIDAN",
